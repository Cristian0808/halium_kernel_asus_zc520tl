...
//ranyanhao 20160114 being
	return 0;
//ranyanhao 20160114 end
	...
	if (BMT_status.bat_charging_state == CHR_ERROR) {
		...
		//lvwenkang 20160517 begin
			...
			if((BMT_status.temperature > 0) && (BMT_status.temperature < 10))
				{
							#ifdef CONFIG_WIND_DEF_PRO_E281L
							g_temp_CC_value = CHARGE_CURRENT_800_00_MA;
							#else
							g_temp_CC_value = CHARGE_CURRENT_668_00_MA;
							#endif
		...
		battery_log(BAT_LOG_CRTI,"wind_log_CC_current = %d\n", g_temp_CC_value);     //added by lvwenkang    20160509
...
//ranyanhao 20160317 end		
			...
			#endif
			battery_log(BAT_LOG_CRTI,"wind_log_CV_voltage = %d\n", cv_voltage); //added by lvwenkang    20160509
			battery_charging_control(CHARGING_CMD_SET_CV_VOLTAGE, &cv_voltage);
...
{
	extern unsigned int g_charger_state ;//added by lvwenkang  20160518 for AGING_POWER_TEST
	...
	#endif
	//ranyanhao 20160122 end
	//added by lvwenkang  20160518 for AGING_POWER_TEST begin
	...
	//added by lvwenkang  20160518 for AGING_POWER_TEST end
	battery_charging_control(CHARGING_CMD_ENABLE, &charging_enable);
