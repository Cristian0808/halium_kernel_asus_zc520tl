...
//liukangping 20160310 begin

u8 FP_GF318_fwvr; 
u16 FP_GF318_vendor;
char FP_GF318_id_str[20];


//liukangping 20160310 end

//ranyanhao 20160113 begin
u16 g_bat_id;
...
static ssize_t show_FP_info(struct device *dev,struct device_attribute *attr, char *buf)
{
	...
	buf_temp += sprintf(buf_temp, "vendor:0x%x-",FP_GF318_vendor);
	buf_temp += sprintf(buf_temp, "fwvr:0x%02x(%u)\n", FP_GF318_fwvr,FP_GF318_fwvr);
...
// liukangping 20151103 begin
static DEVICE_ATTR(FP_info, 0664, show_FP_info, store_FP_info);
// liukangping 20151103 end

// liulinsheng 20160229 begin
...
// zhaozhensen 20150326 begin
//static DEVICE_ATTR(fp_info, 0664, show_fp_info, store_fp_info);
// zhaozhensen 20160326 end
