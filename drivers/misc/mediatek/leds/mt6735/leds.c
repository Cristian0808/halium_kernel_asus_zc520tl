...
//hebiao 20160219 add for SGM3785 begin
int flashlight_set_pwm_old(u32 hduration, u32 lduration, u32 level)
{
	...
	pwm_setting.clk_div = CLK_DIV2;	//liuying 20150312 for mt6732 use 26Mhz clk source
...
//hebiao 20160219 add for SGM3785 end
