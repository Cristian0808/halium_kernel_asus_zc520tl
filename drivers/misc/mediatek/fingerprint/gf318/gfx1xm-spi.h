...
#include "../../../spi/mediatek/mt6735/mt_spi.h"//add xielei
#include "../../../spi/mediatek/mt6735/mt_spi_hal.h"//add xielei
...
/*modified by lizusheng 20160412 start*/
#define GFX1XM_INPUT_HOME_KEY   KEY_F11//KEY_HOMEPAGE
/*modified by lizusheng 20160412 end*/
...
struct gfx1xm_dev {
	...
	//liukangping add sheep 20160504 begin
	struct notifier_block notifier;
	char fb_black;
	//liukangping add sheep 20160504 end
};
...
//lizusheng 20160412 for bug #106771 start
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xd4,0x01,\
}
...
//lizusheng 20160412 for bug #106771 end
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x53,0x01,\
}
...
#define  GF_IOC_CMD       _IOWR(GF_IOC_MAGIC, 1, struct gfx1xm_ioc_transfer)
#define  GF_IOC_REINIT    _IO(GF_IOC_MAGIC, 0)
#define  GF_IOC_SETSPEED  _IOW(GF_IOC_MAGIC, 2, u32)
#define  GF_IOC_SLEEP    _IO(GF_IOC_MAGIC, 3)
//liuakangping add sleep begin 20160504
#define  GF_IOC_PM_FBCABCK   _IO(GF_IOC_MAGIC, 10)
...
inline static long _set_state(const char *name)
{
	...
	//pState = pinctrl_lookup_state(this_pctrl, finger_rst_low);
	if (IS_ERR(pState)) {
...
inline static long spi_dts_gpio_init(struct  gfx1xm_dev *pdev)
{
	...
	node = of_find_compatible_node(NULL, NULL,"mediatek,gf318m");
	#if 1
	if(node){
