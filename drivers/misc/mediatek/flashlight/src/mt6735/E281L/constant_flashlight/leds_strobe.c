...
extern int flashlight_set_pwm_old(u32 hduration, u32 lduration, u32 level);//hebiao 20160219 begin

//ranyanhao 20160331 begin
...
int FL_Enable(void)
{
	...
	int level =0;
/*
//ranyanhao 20160406 begin
#ifdef CONFIG_WIND_ASUS_DEMAND_SUPPORT
    if (asus_flash_brightness_flag == 0) {
#endif
//ranyanhao 20160406 end 
*/
	...
	//hebiao 20160527 begin
		if (asus_flash_lock) {
			...
			flashlight_set_pwm_old(hduration,lduration,99);
		}
	//hebiao 20160527 end
	}
	//flash mode
