...
/****************************   Modify end    *******************************************/
 // zhaozhensen 20160619 begin
extern void read_s5k3l8_eeprom_mtk_fmt(void);
 // zhaozhensen 20160619 end
...
{
//yutao modefy the read func from byte read to int32 read begin
    return ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001));
//yutao modefy the read func from byte read to int32 read end
}
