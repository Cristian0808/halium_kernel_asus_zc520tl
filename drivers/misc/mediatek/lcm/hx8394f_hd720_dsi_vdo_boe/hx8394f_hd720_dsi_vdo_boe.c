//modified ranyanhao 20160215 begin
...
static struct LCM_setting_table lcm_initialization_setting1[] = 
{
	...
	//0xSet0xPanel,0x
	{0xCC, 1,{0x0B}},  //ranyanhao 20160302 modify the display direction
...
static void lcm_suspend(void) 
{
	...
	mt_set_gpio_mode(GPIO_LCD_BIAS_ENP_PIN, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_LCD_BIAS_ENP_PIN, GPIO_DIR_OUT);
// zhaozhensen 20160322 begin
	mt_set_gpio_out(GPIO_LCD_BIAS_ENP_PIN, GPIO_OUT_ZERO);
// zhaozhensen 20160322 end
#endif
...
//modified ranyanhao 20160215 end
