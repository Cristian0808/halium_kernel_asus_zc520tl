...
//liulinsheng 20160331 begin

const u32 CS_VTH[] = {	
	CHARGE_CURRENT_668_00_MA, CHARGE_CURRENT_789_00_MA, CHARGE_CURRENT_910_00_MA,	    
		CHARGE_CURRENT_1032_00_MA,	
		CHARGE_CURRENT_1154_00_MA, CHARGE_CURRENT_1275_00_MA, CHARGE_CURRENT_1396_00_MA,	    
		CHARGE_CURRENT_1518_00_MA
};
//liulinsheng 20160331 end
...
#endif
//ranyanhao 20160222 begin
	fan5405_reg_config_interface(0x06, 0x77);  //0x06 reg set max current and max vol
//ranyanhao 20160222 end
	fan5405_reg_config_interface(0x00, 0xC0);	/* kick chip watch dog */
	fan5405_reg_config_interface(0x01, 0x88);	/* TE=1, CE=0, HZ_MODE=0, OPA_MODE=0 modified by lvwenkang 20160418*/
	fan5405_reg_config_interface(0x05, 0x04);
	if (!charging_init_flag) {
		fan5405_reg_config_interface(0x04, 0x19);// modified by lvwenkang@wind.com set  Iterm = 118mA 
...
static u32 charging_set_cv_voltage(void *data)
{
	...
	printk("wind_log_cv_voltage_register_value = %d\n",register_value);
...
static u32 charging_set_current(void *data)
{
	...
	printk("wind_log_charging_set_current = %d\n",*(u32 *) (data));
	if (current_value <= CHARGE_CURRENT_350_00_MA) {
		...
		printk("wind_log_set_chr_current = %d\n",set_chr_current);
