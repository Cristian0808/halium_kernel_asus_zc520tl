...
#define NLTEE_EVENT_RPC_GET_FLAG	    NLTEE_EVENT_RPC_CMD(1)
...
//add by yr 20160223
#define NLTEE_EXPMOD_RPC_BASE (NLTEE_SERVICE_RPC_BASE + 0x600)
#define NLTEE_EXPMOD_RPC_CMD(num) (NLTEE_EXPMOD_RPC_BASE + num)
#define NLTEE_EXPMOD_RPC NLTEE_EXPMOD_RPC_CMD(0)


//add by yr 20160223
#define NLTEE_ISPRIME_RPC_BASE (NLTEE_SERVICE_RPC_BASE + 0x700)
#define NLTEE_ISPRIME_RPC_CMD(num) (NLTEE_ISPRIME_RPC_BASE + num)
#define NLTEE_ISPRIME_RPC NLTEE_ISPRIME_RPC_CMD(0)
